...
function applyQuickstartItems(items) {
...
function applyResourcesItems(items) {
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  chrome.storage.local.get(["savedResources"], applyResourcesItems);

  chrome.storage.local.get(["savedQuickstart"], applyQuickstartItems);
